...
@endif
      ...
      @if ($terpakai == "1")
        ...
        <div class="row">
            <div class="col-md-7">
                <a href="#">
                    <img class="img-responsive" src="http://booklapangan.com/{{$post->foto}}" alt="">
                </a>
            </div>
            <div class="col-md-5">
                ...
                <a href="showlap/{{$post->ID_FASOR}}/{{$tgl}}/{{$start}}/{{$end}}/{{$lapangan}}"><button class="btn btn-primary">Pesan</button></a>
